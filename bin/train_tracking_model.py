...
def main():
    ...
    # Undersample is not compatible with tracking models (yet)
    if "undersample_bf" in experiment_settings or "undersample_space" in experiment_settings:
        raise ValueError("Undersampling strategies are not yet compatible with tracking!")
